class AppUI {
    ...
    static EditSelected() {
        ...
        this.EditGui.Add("Text", ,
            "Format: [Icon] Val (Delay) | Down/Up Key | Btn Event X, Y`nExample: ⌨️ Down A | 🖱️ LButton Down 100, 200 | ⏱️ 50"
        )
        ...
        this.EditGui.Add("Button", "w90 x+10", "🖱️ Mouse").OnEvent("Click", (*) => this.InsertText(
            "`r`n🖱️ LButton Down 0, 0"))
    ...
    static ShowOSD(text, color := "Red") {
        ...
        this.OSD := Gui("+AlwaysOnTop -Caption +ToolWindow +Disabled +E0x20", "MacroOverlay")
        ...
        try WinSetTransparent(150, this.OSD.Hwnd) ; Semi-transparent (0-255)
    }
